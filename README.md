...
Een ASP.NET Core MVC applicatie voor het beheren van incident- en servicetickets met MongoDB als database. Het systeem ondersteunt twee gebruikersrollen:
...
## Gemaakt door Kuba Kubicki, Miguel Dominguez Romero en Noah Vrasdonk
### Hogeschool Inholland Haarlem - Informatica - leerjaar 2 - NoSQL 
